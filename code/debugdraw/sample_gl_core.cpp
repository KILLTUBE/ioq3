...
#include "../gl3w/GL/gl3w.h"          // An OpenGL extension wrangler (https://github.com/skaslev/gl3w).
#include <assert.h>
...
void sampleAppDraw(DDRenderInterfaceCoreGL & ddRenderIfaceGL) {
...
DDRenderInterfaceCoreGL *ddRenderIfaceGL = NULL;

extern "C" void debugdraw_render() {

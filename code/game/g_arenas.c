...
void UpdateTournamentInfo( void ) {
  ...
  int score1, score2;
	...
	trap_game_SendConsoleCommand( EXEC_APPEND, msg );
}
...
static void PodiumPlacementThink( gentity_t *podium ) {
	...
	VectorMA( level.intermission_origin, trap_game_Cvar_VariableIntegerValue( "g_podiumDist" ), vec, origin );
	origin[2] -= trap_game_Cvar_VariableIntegerValue( "g_podiumDrop" );
